...
const createUser = async (request, h) => {
    try {
        ...
        const query = "INSERT INTO table_user(user_name, user_email, user_password) VALUES(?, ?, ?)";
...
const updateUser = async (request, h) => {
    ...
    try {
        ...
        await new Promise((resolve, reject) => {
            db.query(query, [name, age, height, weight, limit, userId], (err, rows, field) => {
                if (err) {
                    reject(err);
                } else {
                    resolve();
...
module.exports = { createUser, readUser, loginUser, updateUser };